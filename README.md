...
[![npm version](https://badge.fury.io/js/@dramaorg/totam-sed-architecto.svg)](https://badge.fury.io/js/@dramaorg/totam-sed-architecto)
[![downloads count](https://img.shields.io/npm/dt/@dramaorg/totam-sed-architecto.svg)](https://www.npmjs.com/package/@dramaorg/totam-sed-architecto)
[![github-ci](https://github.com/dramaorg/totam-sed-architecto/actions/workflows/testing.yml/badge.svg)](https://github.com/dramaorg/totam-sed-architecto/actions/workflows/testing.yml)
...
Next, install `@dramaorg/totam-sed-architecto`:

```bash
npm install -D @dramaorg/totam-sed-architecto
```
